...
module.exports.cors = {
    ...
    headers: 'accept,Access-Control-Allow-Origin,access-control-request-headers,access-control-request-method,content-type,origin,referer,user-agent,authorization,vendortoken'
